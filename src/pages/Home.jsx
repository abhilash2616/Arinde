            ...
            >
              ...
              <div className="flex w-[70%] gap-x-6 py-20 items-center">
                <p className="max-w-[90%]">
                  ARINDE has worked on projects nationwide and worldwide,
                  designs that make magic happen, without the wand. focuses more
                  on structural design, whereas interior design is the practice
                  of creating interior atmosphere. This involves carefully
                  designing lines, colors, plants, lighting, building materials,
                  and space to create an area that feels nurturing to the human
                  body.
                </p>
                <motion.img
